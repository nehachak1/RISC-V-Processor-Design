module controller (
    ...
    parameter CSR    = 7'h73;
    parameter EBREAK  = 7'b0000100; // not opcode
    parameter INTERRUPT_RETURN = 7'b0001000; // not opcode
    ...
    always @(*) begin
        ...
        case (state_r)
            ...
            DECODE: begin
                if (instruction_i[6:0] == CSR && instruction_i[14:12] == 0) begin
                    next_state_r = instruction_i[31:20] == 12'h302 ? INTERRUPT_RETURN : EBREAK;
                end else begin
            ...
            CSR:    begin
                sel_csr_o = 1;
                rf_we_o = 1;
                sel_imm_o = instruction_i[14];
                imm_o = instruction_i[14] ? {27'b0, instruction_i[19:15]} : 0;
                case (instruction_i[13:12])
                    2'b01: csr_write_o = 1;
                    2'b10: csr_set_o   = 1;
                    2'b11: csr_clear_o = 1;
                    default: ;
